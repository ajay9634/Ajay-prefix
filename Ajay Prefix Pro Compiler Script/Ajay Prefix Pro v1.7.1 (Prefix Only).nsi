; ---------------------------------------------------------
; Ajay Prefix Pro v1.7.1 Installer - License Button
; ---------------------------------------------------------
...
; --------------------------------
; General Settings
Name "Ajay Prefix Pro v1.7.1 (Prefix Only)"
OutFile "Ajay Prefix Pro v1.7.1 Installer.exe"
...
Function OptionsPage
  ...
  SendMessage $HWNDPARENT ${WM_SETTEXT} 0 "STR:Ajay Prefix Pro v1.7.1 (Prefix Only) Setup"
