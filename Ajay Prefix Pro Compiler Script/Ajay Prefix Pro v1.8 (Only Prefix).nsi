; ---------------------------------------------------------
; Ajay Prefix Pro v1.8 Installer - License Button
; ---------------------------------------------------------
...
; --------------------------------
; General Settings
Name "Ajay Prefix Pro v1.8 (Only Prefix)"
OutFile "Ajay Prefix Pro v1.8 Installer.exe"
...
Function OptionsPage
  ...
  SendMessage $HWNDPARENT ${WM_SETTEXT} 0 "STR:Ajay Prefix Pro v1.8 (Only Prefix) Setup"
