...
rmdir /S /Q "C:\ProgramData\Microsoft\Windows\Start Menu\Ajay Start Menu\3.GPU Test" >nul 2>&1
    ...
    D:\Ajay_prefix\.Resources\7z.exe x D:\Ajay_prefix\.Resources\Start_Menu.7z -oC:\ -p-q -y -r "2.offline components\*" "3.GPU Test\*" "Check_Ajay_prefix_status.bat" "install necessary files.bat" >NUL 2>&1
    ) else ( goto checked )
