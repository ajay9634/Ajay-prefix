...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%_64.zip" (
    wget -O D:/Ajay_prefix/wget_files/d3d/%installname%_64.zip https://downloads.fdossena.com/Projects/WineD3D/Builds/WineD3DForWindows_4.18-x86_64.zip
...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%.zip" (
    wget -O D:/Ajay_prefix/wget_files/d3d/%installname%.zip https://downloads.fdossena.com/Projects/WineD3D/Builds/WineD3DForWindows_4.18.zip
