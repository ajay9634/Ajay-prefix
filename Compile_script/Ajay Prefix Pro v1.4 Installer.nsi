; --------------------------------
; Ajay Prefix Pro v1.4 Installer - Stable Menu
; --------------------------------
...
; --------------------------------
; General Settings
Name "Ajay Prefix Pro v1.4"
OutFile "Ajay Prefix Pro v1.4 Installer.exe"
...
Function OptionsPage
  ...
  SendMessage $HWNDPARENT ${WM_SETTEXT} 0 "STR:Ajay Prefix Pro v1.4 Setup"
  ...
  ${NSD_CreateLabel} 0 0 100% 30u "Welcome to Ajay Prefix Pro v1.4.$\r$\nSelect an action and click Execute. Select Exit when finished."
  Pop $0
