...
color 0a
echo *** Installing Xvid-1.3.7-20191228 ***
...
echo *** install Xvid-1.3.7-20191228 manually ***
Start /wait %drive_letter%:\Ajay_prefix\wget_files\temp\Xvid-1.3.7-20191228.exe
echo ************************************************
