...
IF NOT EXIST "D:\Ajay_prefix\wget_files\dsound\dsound.7z" (
    wget -P D:/Ajay_prefix/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/winlator-ajay/main/My-files/dsound.7z
...
echo *** installing...***
Xcopy /s /y D:\Ajay_prefix\wget_files\temp\dsound-wine-ptoton-9.0.2\ C:\windows\ /E /H /C /I
)
echo.************************************************
