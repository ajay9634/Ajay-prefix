...
IF NOT EXIST "D:\Ajay_prefix\wget_files\Files\d3d9_32bit_v1.60_wrapper_by_ThirteenAG.7z" (
    echo *** Downloading d3d9_32bit_v1.60_wrapper_by_ThirteenAG...***
    wget -q --show-progress -P D:/Ajay_prefix/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Resources/My-files/d3d9_32bit_v1.60_wrapper_by_ThirteenAG.7z
    copy /y D:\Ajay_prefix\wget_files\temp\d3d9_32bit_v1.60_wrapper_by_ThirteenAG.7z D:\Ajay_prefix\wget_files\Files\
) ELSE (
...
D:\Ajay_prefix\.Resources\7z.exe x D:\Ajay_prefix\wget_files\Files\d3d9_32bit_v1.60_wrapper_by_ThirteenAG.7z -oD:\Ajay_prefix\wget_files\temp\ -p-q -r -y >NUL 2>&1
