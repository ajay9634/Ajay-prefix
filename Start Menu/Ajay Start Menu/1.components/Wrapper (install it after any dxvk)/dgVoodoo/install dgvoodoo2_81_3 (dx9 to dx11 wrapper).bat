...
IF NOT EXIST "%drive_letter%:\Ajay_prefix\wget_files\d3d\dgVoodoo2_81_3.7z" (
    wget -q --show-progress -P %drive_letter%:/Ajay_prefix/wget_files/temp/ https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Resources/My-files/dgVoodoo2_81_3.7z
    copy /s /y %drive_letter%:\Ajay_prefix\wget_files\temp\dgVoodoo2_81_3.7z %drive_letter%:\Ajay_prefix\wget_files\d3d\dgVoodoo2_81_3.7z /E /H /C /I
) ELSE (
...
color 1f
echo *** Extracting ...***
%drive_letter%:\Ajay_prefix\.Resources\7z.exe x %drive_letter%:\Ajay_prefix\wget_files\d3d\dgVoodoo2_81_3.7z -o%drive_letter%:\Ajay_prefix\wget_files\temp\ -p-q -y -ir!d3dImm.dll >NUL 2>&1
