...
set "installname=dxwrapper_1.3.7700.25_winmm"
...
echo *** adding winmm as native, builtin ***
reg add "HKCU\Software\Wine\DllOverrides" /v winmm /t REG_SZ /d native,builtin /f
...
del %tmp%\tmp.vbs
call "C:\Windows\Ajay_drive.bat" >nul 2>&1
Start "" %drive_letter%:\Ajay_prefix\wget_files\temp\dxwrapper_1.3.7700.25_winmm.exe
timeout.exe /t 4 >nul
echo ************************************************
