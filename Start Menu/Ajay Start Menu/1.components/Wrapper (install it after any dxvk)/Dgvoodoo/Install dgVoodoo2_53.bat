...
if /i "%choice%"=="1" (
    ...
    xcopy /y "%TEMPDIR%\MS\*.*" "C:\Windows\SysWOW64\" >nul
    xcopy /y "%TEMPDIR%\3Dfx\*.*" "C:\Windows\SysWOW64\" >nul
    echo [ OK  ] Files copied to SysWOW64
    echo [INFO] Opening conf ...
    Start "" "%TEMPDIR%\dgVoodooSetup.exe"
    goto :end
)
...
if /i "%choice%"=="2" (
    ...
    if exist "%FOLDER_OUT%" (
        ...
        xcopy /y "%TEMPDIR%\dgVoodooSetup.exe" "!GAMEFOLDER!\" >nul
        echo [ OK  ] Files copied to game folder
        echo [INFO] Opening conf ...
        Start "" "!GAMEFOLDER!\dgVoodooSetup.exe"
    ) else (
        ...
        xcopy /s /e /h /y "%TEMPDIR%\dgVoodooSetup.exe" "!GAMEFOLDER!\" >nul
