@echo off
color 84
title VC Redist 2017 Installer by Ajay
...
:Uninstall_local
echo.
echo *** Uninstalling VC Redist files ***
...
color 0A
echo.
echo *** Downloading vc_redist_2017 ***
IF NOT EXIST "%drive_letter%:\Ajay_prefix\wget_files\Files\vc_redist_2017.7z" (
    wget -q --show-progress -P %drive_letter%:/Ajay_prefix/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Resources/My-files/vc_redist_2017.7z
    copy /s /y %drive_letter%:\Ajay_prefix\wget_files\temp\vc_redist_2017.7z %drive_letter%:\Ajay_prefix\wget_files\Files\vc_redist_2017.7z /E /H /C /I
) ELSE (
    ECHO vc_redist_2017 already exists.
)


color 1f
echo *** Extracting ...***
%drive_letter%:\Ajay_prefix\.Resources\7z.exe x %drive_letter%:\Ajay_prefix\wget_files\Files\vc_redist_2017.7z -o%drive_letter%:\Ajay_prefix\wget_files\temp\ -p-q -r -y >NUL 2>&1

Start /wait %drive_letter%:\Ajay_prefix\wget_files\temp\vc_redist_2017.x86.exe /repair /norestart
Start /wait %drive_letter%:\Ajay_prefix\wget_files\temp\vc_redist_2017.x64.exe /repair /norestart
