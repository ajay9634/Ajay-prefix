...
IF NOT EXIST "D:\Ajay_prefix\wget_files\Files\Winlator_Cmod_MangoHud_WIP.7z" (
    wget -P D:/Ajay_prefix/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/winlator-ajay/main/My-files/Winlator_Cmod_MangoHud_WIP.7z
) ELSE (
