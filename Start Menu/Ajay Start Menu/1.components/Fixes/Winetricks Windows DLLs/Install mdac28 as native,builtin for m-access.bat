...
reg add "HKCU\Software\Wine\DllOverrides" /v mtxdm    /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v ODBC32    /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v ODBCCP32    /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v oledb32    /d "native,builtin" /f >nul
