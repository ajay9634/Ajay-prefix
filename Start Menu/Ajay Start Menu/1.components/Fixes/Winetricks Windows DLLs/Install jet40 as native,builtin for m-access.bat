...
reg add "HKCU\Software\Wine\DllOverrides" /v msjet40    /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v msjint40   /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v msjter40   /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v msrd3x40   /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v dao360     /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v vbajet32   /d "native,builtin" /f >nul
