...
reg add "HKCU\Software\Wine\DllOverrides" /v jscript    /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v scrrun    /d "native,builtin" /f >nul
reg add "HKCU\Software\Wine\DllOverrides" /v vbscript    /d "native,builtin" /f >nul
