...
echo ==========================================================
echo     Microsoft Visual C++ 2022 Redistributable (x64/x86)
echo     Registry Installer - by Ajay
echo     Version: 14.44.35208.0
echo ==========================================================
...
reg add "HKLM\SOFTWARE\Microsoft\DevDiv\VC\Servicing\14.0\RuntimeAdditional" /v UpdateVersion /t REG_SZ /d 14.44.35208.0 /f
reg add "HKLM\SOFTWARE\Microsoft\DevDiv\VC\Servicing\14.0\RuntimeAdditional" /v Version /t REG_SZ /d 14.44.35208.0 /f
...
reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\DevDiv\VC\Servicing\14.0\RuntimeAdditional" /v UpdateVersion /t REG_SZ /d 14.44.35208.0 /f
reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\DevDiv\VC\Servicing\14.0\RuntimeAdditional" /v Version /t REG_SZ /d 14.44.35208.0 /f
...
reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\DevDiv\VC\Servicing\14.0\RuntimeMinimum" /v UpdateVersion /t REG_SZ /d 14.44.35208.0 /f
reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\DevDiv\VC\Servicing\14.0\RuntimeMinimum" /v Version /t REG_SZ /d 14.44.35208.0 /f

:: === VC Runtime Runtimes (X64) ===

reg add "HKLM\SOFTWARE\Microsoft\VisualStudio\14.0\VC\Runtimes\X64" /v Bld /t REG_DWORD /d 33326 /f
...
reg add "HKLM\SOFTWARE\Microsoft\VisualStudio\14.0\VC\Runtimes\X64" /v Version /t REG_SZ /d v14.44.35208.0 /f

:: === VC Runtime Runtimes (X86) ===

reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\VisualStudio\14.0\VC\Runtimes\X86" /v Bld /t REG_DWORD /d 33326 /f
...
reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\VisualStudio\14.0\VC\Runtimes\X86" /v Version /t REG_SZ /d v14.44.35208.0 /f

echo.
echo [ OK ] VC++ 2022 registry installed (x64 + x86).
echo.
