...
IF NOT EXIST "D:\Ajay_prefix\wget_files\d3d\vkd3d-proton-dev.281024.7z" (
    wget -P D:/Ajay_prefix/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/winlator-ajay/main/My-files/vkd3d-proton-dev.281024.7z
