...
%drive_letter%:\Ajay_prefix\.Resources\7z.exe x %drive_letter%:\Ajay_prefix\wget_files\temp\dosbox_script.7z -o%drive_letter%:\Ajay_prefix\wget_files\my_apps\DOSBox-SVN-Daum\ -r -y >NUL 2>&1

echo *** opening dosbox-64bit ***
call "C:\Windows\Ajay_drive.bat" >nul 2>&1
Start %drive_letter%:\Ajay_prefix\wget_files\my_apps\DOSBox-SVN-Daum\dosbox_x64.exe
echo ************************************************
timeout.exe /t 3 >nul
