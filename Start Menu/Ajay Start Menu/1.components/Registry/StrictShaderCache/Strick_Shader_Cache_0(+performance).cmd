@echo off
echo Setting "strict_shader_math" to "dword:00000000" in the registry...

:: Add or update the strict_shader_math key as a DWORD silently
reg add "HKEY_CURRENT_USER\Software\Wine\Direct3D" /v "strict_shader_math" /t REG_DWORD /d 0 /f >nul 2>&1
