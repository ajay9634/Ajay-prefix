@echo off
echo Setting "FontSmoothing" to "4" and "LogPixels" to "dword:00000078" in the registry...
...
reg add "HKEY_CURRENT_USER\Control Panel\Desktop" /v "LogPixels" /t REG_DWORD /d 120 /f >nul 2>&1
