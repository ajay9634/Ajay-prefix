...
color 0a
if exist "%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\Direct3D\Bin\x86\ParallaxOcclusionMapping.exe" goto Run
...
Start /wait "" %drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\Direct3D\Bin\x86\ParallaxOcclusionMapping.exe
