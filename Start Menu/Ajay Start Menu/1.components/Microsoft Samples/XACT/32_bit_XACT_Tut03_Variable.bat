@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x86\Tut03_Variable.lnk" goto Run
...
set "targetPath=D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x86\Tut03_Variable.exe"
set "shortcutPath=D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x86\Tut03_Variable.lnk"
...
Start ""  D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x86\Tut03_Variable.lnk
