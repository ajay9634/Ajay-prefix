@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XACT\Bin\x64\Tut03_Variable.lnk" goto Run
...
Start /b "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XACT\Bin\x64\Tut03_Variable.lnk
