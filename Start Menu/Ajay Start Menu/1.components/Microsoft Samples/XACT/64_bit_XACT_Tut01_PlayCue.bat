...
color 0a
if exist "%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut01_PlayCue.lnk" goto Run
...
set "targetPath=%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut01_PlayCue.exe"
set "shortcutPath=%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut01_PlayCue.lnk"
...
Start ""  %drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut01_PlayCue.lnk
