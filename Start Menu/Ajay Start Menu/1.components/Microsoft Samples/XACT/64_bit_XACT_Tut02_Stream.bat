...
set "targetPath=D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut02_Stream.exe"
set "shortcutPath=D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut02_Stream.lnk"
...
Start ""  D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XACT\Bin\x64\Tut02_Stream.lnk
