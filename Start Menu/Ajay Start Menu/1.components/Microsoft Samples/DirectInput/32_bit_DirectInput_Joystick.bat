@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\DirectInput\Bin\x86\Joystick.exe" goto Run
...
Start /wait "" D:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\DirectInput\Bin\x86\Joystick.exe
