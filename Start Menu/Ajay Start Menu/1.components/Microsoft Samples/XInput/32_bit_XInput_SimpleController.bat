@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XInput\Bin\x86\SimpleController.exe" goto Run
...
Start /wait "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XInput\Bin\x86\SimpleController.exe
