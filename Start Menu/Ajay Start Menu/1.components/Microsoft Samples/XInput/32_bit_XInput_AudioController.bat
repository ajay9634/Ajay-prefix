...
color 0a
if exist "%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XInput\Bin\x86\AudioController.exe" goto Run
...
Start /wait "" %drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XInput\Bin\x86\AudioController.exe
