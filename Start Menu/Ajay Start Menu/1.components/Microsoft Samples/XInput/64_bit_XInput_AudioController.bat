@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XInput\Bin\x64\AudioController.exe" goto Run
...
Start /wait "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XInput\Bin\x64\AudioController.exe
