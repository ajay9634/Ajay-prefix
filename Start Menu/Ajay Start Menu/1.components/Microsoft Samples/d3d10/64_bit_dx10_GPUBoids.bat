@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\Direct3D10\Bin\x64\GPUBoids.exe" goto Run
...
Start /wait "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\Direct3D10\Bin\x64\GPUBoids.exe
