...
color 0a
if exist "%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XAudio2\Bin\x64\XAudio2Sound3D.lnk" goto Run
...
set "targetPath=%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XAudio2\Bin\x64\XAudio2Sound3D.exe"
set "shortcutPath=%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XAudio2\Bin\x64\XAudio2Sound3D.lnk"
...
Start ""  %drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\XAudio2\Bin\x64\XAudio2Sound3D.lnk
