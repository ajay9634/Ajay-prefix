@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XAudio2\Bin\x64\XAudio2Sound3D.lnk" goto Run
...
Start /b "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XAudio2\Bin\x64\XAudio2Sound3D.lnk
