@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XAudio2\Bin\x86\XAudio2BasicStream.lnk" goto Run
...
Start /b "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\XAudio2\Bin\x86\XAudio2BasicStream.lnk
