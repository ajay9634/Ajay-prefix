@echo off
color 0a
if exist "D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\Direct3D11\Bin\x86\SimpleBezier11.exe" goto Run
...
Start /wait "" D:\Ajay_prefix\wget_files\temp\Microsoft_Samples\C++\Direct3D11\Bin\x86\SimpleBezier11.exe
