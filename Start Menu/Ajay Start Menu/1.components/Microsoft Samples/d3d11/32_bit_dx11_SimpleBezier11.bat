...
color 0a
if exist "%drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\Direct3D11\Bin\x86\SimpleBezier11.exe" goto Run
...
Start /wait "" %drive_letter%:\Ajay_prefix\wget_files\temp2\Microsoft_Samples\C++\Direct3D11\Bin\x86\SimpleBezier11.exe
