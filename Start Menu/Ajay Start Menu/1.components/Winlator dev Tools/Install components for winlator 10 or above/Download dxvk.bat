...
:: Create installed_components/dxvk inside files if it doesn't exist
if not exist "E:\files\installed_components\dxvk" (
    mkdir "E:\files\installed_components\dxvk"
    echo Folder 'installed_components/dxvk' created successfully.
) else (
    echo Folder 'installed_components/dxvk' already exists.
)
...
IF "%userChoice%"=="1" (
    ...
    set "apiURL=https://api.github.com/repos/ajay9634/Ajay-prefix/contents/installable_components/dxvk?ref=Winlator-10-stuff"
goto download
    exit /b
)
...
IF "%userChoice%"=="2" (
    ...
    set "apiURL=https://api.github.com/repos/brunodev85/winlator/contents/installable_components/dxvk?ref=main"
goto download
    exit /b
)
...
set "fileURL=https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Winlator-10-stuff/installable_components/dxvk/!selectedFile!"

:: Check if the file already exists, delete if present
if exist "E:\files\installed_components\dxvk\!selectedFile!" (
    echo File already exists. Deleting...
    del /f /q "E:\files\installed_components\dxvk\!selectedFile!"
    if exist "E:\files\installed_components\dxvk\!selectedFile!" (
...
echo Downloading !selectedFile! to E:\files\installed_components\dxvk...
wget --retry-connrefused --waitretry=3 --timeout=30 --tries=5 -O "E:\files\installed_components\dxvk\!selectedFile!" "!fileURL!"

:: Check if download succeeded
if exist "E:\files\installed_components\dxvk\!selectedFile!" (
    echo Download successful: E:\files\installed_components\dxvk\!selectedFile!
) else (
