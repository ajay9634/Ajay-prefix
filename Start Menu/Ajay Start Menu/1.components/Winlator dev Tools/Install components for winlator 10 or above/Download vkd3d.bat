...
:: Create installed_components/vkd3d inside files if it doesn't exist
if not exist "E:\files\installed_components\vkd3d" (
    mkdir "E:\files\installed_components\vkd3d"
    echo Folder 'installed_components/vkd3d' created successfully.
) else (
    echo Folder 'installed_components/vkd3d' already exists.
)
...
:choice
echo .
echo Select GitHub to download vkd3d -
echo [1] Ajay9634
echo [2] brunodev85
echo [3] Cancel
echo .
...
IF "%userChoice%"=="1" (
    ...
    set "apiURL=https://api.github.com/repos/ajay9634/Ajay-prefix/contents/installable_components/vkd3d?ref=Winlator-10-stuff"
goto download
    exit /b
)
...
IF "%userChoice%"=="2" (
    ...
    set "apiURL=https://api.github.com/repos/brunodev85/winlator/contents/installable_components/vkd3d?ref=main"
goto download
    exit /b
)
...
set "fileURL=https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Winlator-10-stuff/installable_components/vkd3d/!selectedFile!"

:: Check if the file already exists, delete if present
if exist "E:\files\installed_components\vkd3d\!selectedFile!" (
    echo File already exists. Deleting...
    del /f /q "E:\files\installed_components\vkd3d\!selectedFile!"
    if exist "E:\files\installed_components\vkd3d\!selectedFile!" (
...
echo Downloading !selectedFile! to E:\files\installed_components\vkd3d...
wget --retry-connrefused --waitretry=3 --timeout=30 --tries=5 -O "E:\files\installed_components\vkd3d\!selectedFile!" "!fileURL!"

:: Check if download succeeded
if exist "E:\files\installed_components\vkd3d\!selectedFile!" (
    echo Download successful: E:\files\installed_components\vkd3d\!selectedFile!
) else (
