...
:: Create installed_components/Box64 inside files if it doesn't exist
if not exist "E:\files\installed_components\Box64" (
    mkdir "E:\files\installed_components\Box64"
    echo Folder 'installed_components/Box64' created successfully.
) else (
    echo Folder 'installed_components/Box64' already exists.
)
...
set "fileURL=https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Winlator-10-stuff/installable_components/Box64/!selectedFile!"

:: Check if the file already exists, delete if present
if exist "E:\files\installed_components\Box64\!selectedFile!" (
    echo File already exists. Deleting...
    del /f /q "E:\files\installed_components\Box64\!selectedFile!"
    if exist "E:\files\installed_components\Box64\!selectedFile!" (
...
echo Downloading !selectedFile! to E:\files\installed_components\Box64...
wget --retry-connrefused --waitretry=3 --timeout=30 --tries=5 -O "E:\files\installed_components\Box64\!selectedFile!" "!fileURL!"

:: Check if download succeeded
if exist "E:\files\installed_components\Box64\!selectedFile!" (
    echo Download successful: E:\files\installed_components\Box64\!selectedFile!
) else (
