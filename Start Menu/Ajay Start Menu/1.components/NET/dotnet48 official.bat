...
IF EXIST "D:/Ajay_prefix/wget_files/NET/dotNetFx48_Full_x86_x64.din" (
    ...
    echo.
    wget -O "D:/Ajay_prefix/wget_files/temp/dotNetFx48_Full_x86_x64.exe" --progress=dot:mega https://download.visualstudio.microsoft.com/download/pr/7afca223-55d2-470a-8edc-6a1739ae3252/abd170b4b0ec15ad0222a809b761a036/ndp48-x86-x64-allos-enu.exe
