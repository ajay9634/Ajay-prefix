...
IF NOT EXIST "D:\Ajay_prefix\wget_files\NET\xnafx31_redist.7z" (
    wget -P D:/Ajay_prefix/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/winlator-ajay/main/My-files/xnafx31_redist.7z
...
color 1f
echo *** Extracting ...***
D:\Ajay_prefix\.Resources\7z.exe x D:\Ajay_prefix\wget_files\NET\xnafx31_redist.7z -oD:\Ajay_prefix\wget_files\temp\ -r -y >NUL 2>&1
echo *** installing ...***
Start D:\Ajay_prefix\wget_files\temp\xnafx31_redist.msi. )
echo.************************************************