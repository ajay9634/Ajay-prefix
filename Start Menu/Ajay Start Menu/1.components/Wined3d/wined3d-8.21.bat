...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%_64.zip" (
    ...
    echo Extracting....
    D:\Ajay_prefix\.Resources\winrar.exe x D:\Ajay_prefix\wget_files\d3d\%installname%_64.zip C:\windows\temp\ -r -y >NUL 2>&1
    ren "C:\windows\temp\wined3d" system32
    echo installing 64bit dlls....
Xcopy /s /y C:\windows\temp\system32\ C:\windows\system32\ /E /H /C /I
) ELSE (
    ECHO file already exists. echo echo Extracting....
    D:\Ajay_prefix\.Resources\winrar.exe x D:\Ajay_prefix\wget_files\d3d\%installname%_64.zip C:\windows\temp\ -r -y >NUL 2>&1
    ren "C:\windows\temp\wined3d" system32
    echo installing 64bit dlls....
Xcopy /s /y C:\windows\temp\system32\ C:\windows\system32\ /E /H /C /I
