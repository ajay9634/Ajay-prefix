...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%_64.zip" (
    wget -q --show-progress -P D:/Ajay_prefix/wget_files/temp/ https://downloads.fdossena.com/Projects/WineD3D/Builds/WineD3DForWindows_8.11-x86_64.zip
    ren D:/Ajay_prefix/wget_files/temp/WineD3DForWindows_8.11-x86_64.zip %installname%_64.zip
...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%.zip" (
    wget -q --show-progress -P D:/Ajay_prefix/wget_files/temp/ https://downloads.fdossena.com/Projects/WineD3D/Builds/WineD3DForWindows_8.11.zip
    ren D:/Ajay_prefix/wget_files/temp/WineD3DForWindows_8.11.zip %installname%.zip
