...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%_64.zip" (
    wget -q --show-progress -P D:/Ajay_prefix/wget_files/temp/ https://downloads.fdossena.com/Projects/WineD3D/Builds/WineD3DForWindows_4.13-x86_64.zip
    ren D:/Ajay_prefix/wget_files/temp/WineD3DForWindows_4.13-x86_64.zip %installname%_64.zip
...
IF NOT EXIST "D:/Ajay_prefix/wget_files/d3d/%installname%.zip" (
    wget -q --show-progress -P D:/Ajay_prefix/wget_files/temp/ https://downloads.fdossena.com/Projects/WineD3D/Builds/WineD3DForWindows_4.13.zip
        ren D:/Ajay_prefix/wget_files/temp/WineD3DForWindows_4.13.zip %installname%.zip
